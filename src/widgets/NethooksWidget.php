 ...
 * @copyright Copyright (c) 2020 asdf
 */
...
class NethooksWidget extends Widget
{
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'nethooks/_components/widgets/NethooksWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    public function getBodyHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'nethooks/_components/widgets/NethooksWidget_body',
            [
